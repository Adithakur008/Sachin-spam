...
START_OP = [
    [
        Button.url("🍁 ᴅᴇsᴛʀᴏʏᴇʀ", "t.me/ll_Destroyer_of_worldd_ll"),
    ],
    [
    ...
    [
        Button.url("🌸 ᴊᴏɪɴ ғᴏʀ sᴜᴅᴏ 🌸", "https://t.me/destroyer_worldd")
    ],
]
